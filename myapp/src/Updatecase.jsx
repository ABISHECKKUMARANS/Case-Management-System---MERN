...
function UpdateCase() {
  ...
  const validateForm = () => {
    ...
    const requiredFields = [
      'caseid', 'casename', 'casetype', 'casedescription', 
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      alert(`Case ${formData.casename} has been created successfully!`);
      axios.put(`http://localhost:5000/api/case/update/${id}`,formData)
      .then((res)=>{
    ...
    <div className="add-case-cont">
      <div className="add-case-form">
        <div className="add-case-form-header">
          <h1 className="add-case-form-title">Update Case</h1>
          <p className="add-case-form-subtitle">Complete the form below to update case to the system</p>
        </div>
